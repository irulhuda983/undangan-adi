...
class HomeController extends Controller
{
    ...
    {
        $data = $this->adi($request->to);

        return view('template1', ['data' => $data]);
    }

    public function adi($toName)
    {
        $galery = [
        ...
        $data = [
            ...
            'backsound' => asset('assets/audio/backsound_adi.mp3'),
            'background' => [
            ...
            'waktu' => [
                ...
                'bulan' => '07',
                'tahun' => '2024',
                'tglText' => 'Sabtu, 06 Juli 2024',
                'tanggalLengkap' => '2024-07-06 07:00:00',
                'linkKalender' => 'https://calendar.google.com/calendar/u/0/r/eventedit?text=Acara+Pernikahan+Nizar+dan+Adi&ctz=Asia/Jakarta&dates=20240702T120000/20240702T160000%7D&details=Acara+Pernikahan+Nizar+dan+Adi&location=Ds.+Kalitengah+Kec.+Sugio+Kab.-Lamongan,+Jawa+Timur&sprop&sprop=name:',
            ],
            'to' => $toName,
            'pengantinWanita' => [
            ...
            'bank' => [
                ...
                [
                    ...
                    'bankname' => 'BRI',
                    'atasnama' => 'AN. ADI SAPUTRA',
                    'icon' => asset('assets/img/BANK-BRI.png'),
                ]
            ],
        ];

...
<head>
    ...
    <title>Wedding Of {{ $data['pengantinPria']['namaPanggilan'] }} & {{ $data['pengantinWanita']['namaPanggilan'] }}</title>
        ...
        >
            ...
            <div class="w-full p-6 box-border text-white relative z-10">
                <div class="w-full" data-aos="fade-up">
                    <p class="text-5xl mb-5 font-dancing font-semibold">{{ $data['pengantinPria']['namaPanggilan'] }} &amp; {{ $data['pengantinWanita']['namaPanggilan'] }}</p>
                </div>
            ...
            <div class="box-border w-full rounded overflow-hidden">
                <div class="box-border w-full overflow-hidden p-4" style="background: linear-gradient(180deg, transparent 0, transparent 40%, #fff);">
                    ...
                    <div class="w-full relative flex items-center justify-center h-24" data-aos="fade-up">
                        ...
                        <div class="inline-block text-5xl mb-5 font-dancing font-semibold text-gray-500 p-4">{{ $data['pengantinPria']['namaPanggilan'] }} &amp; {{ $data['pengantinWanita']['namaPanggilan'] }}</div>
                    </div>
                </div>
            </div>
